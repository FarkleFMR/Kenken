        ...
        def comprobar():
            ...
            for i in range(len(p)):
                ...
                if vaarios=="":
                    if int(varia)!=comprolinea[0]:
                        messagebox.showerror("Error", "Solucion incorrecta8")
                        comprolinea=[]
                if vaarios=="X":
                    ...
                    for l in comprolinea:
                        ...
                        result+=l
                    if result!=int(varia):
                        messagebox.showerror("Error", "Solucion incorrecta2")
                    ...
                    print(result)
                    if result!=int(varia):
                        messagebox.showerror("Error", "Solucion incorrecta3")
                    comprolinea=[]
                    result=0
                elif vaarios=="/":
                    ...
                    if vardiv!=int(varia):
                        messagebox.showerror("Error", "Solucion incorrecta4")
            ...
            for i in range(len(matriz)):
                for j in matriz[i]:
                    bar=int(j.get())
                    if bar in l1:
                        messagebox.showerror("Error", "Solucion incorrecta5")
                        break
                    else:
                        l1+=[bar]
            ...
            for i in range(len(matriz)):
                for j in range(len(matriz[i])):
                    ...
                    print(bar,l1)
                    if bar in l1:
                        messagebox.showerror("Error", "Solucion incorrecta6")
                        break
                    else:
                        l1+=[bar]
                l1=[]

            messagebox.showerror("Error", "Solucion lograda")
...
def config():
    ...
    niv.grid(row=1,column=1,sticky=W,padx=10,pady=4)
    radio1=Radiobutton(con,text="Easy",variable=v,command=eleccion1(),value=1)
    radio1.grid(row=1,column=2,sticky=W,padx=10,pady=4)
    radio2=Radiobutton(con,text="Normal",variable=v,command=eleccion1(),value=2)
    radio2.grid(row=2,column=2,sticky=W,padx=10,pady=4)
    radio3=Radiobutton(con,text="Dificult",variable=v,command=eleccion1(),value=3)
    radio3.grid(row=3,column=2,sticky=W,padx=10,pady=4)
    rel=Label(con,text="Time")
    rel.grid(row=4,column=1,sticky=W,padx=10,pady=4)
    radio4=Radiobutton(con,text="Yes",variable=v2,command=eleccion2(),value=1)
    radio4.grid(row=4,column=2,sticky=W,padx=10,pady=4)
    radio5=Radiobutton(con,text="No",variable=v2,command=eleccion2(),value=2)
    radio5.grid(row=5,column=2,sticky=W,padx=10,pady=4)
    radio6=Radiobutton(con,text="Timer",variable=v2,command=eleccion2(),value=3)
    radio6.grid(row=6,column=2,sticky=W,padx=10,pady=4)
    sound=Label(con,text="Sound")
    sound.grid(row=7,column=1,sticky=W,padx=10,pady=4)
    radio7=Radiobutton(con,text="Yes",variable=v3,command=eleccion3(),value=1)
    radio7.grid(row=7,column=2,sticky=W,padx=10,pady=4)
    radio8=Radiobutton(con,text="No",variable=v3,command=eleccion3(),value=2)
    radio8.grid(row=8,column=2,sticky=W,padx=10,pady=4)
    def back():
        root.deiconify()
        con.withdraw()
